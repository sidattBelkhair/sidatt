...
Placez votre CV dans ce dossier `/web/assets/cv/` avec le nom de fichier exact :
...
2. Placez-le dans le dossier `/web/assets/cv/`
...
flutter:
  assets:
    - web/assets/cv/CV_SidattBelkhair.pdf
```
